...
const Cta = () => {
    return (
        ...
        <main className='p-10 flex flex-col items-center mt-20 gap-10'>
            <h1 className='font-bold text-4xl border-b-4 border-[#670000]'>Our Core Value</h1>
            <div className=' grid grid-cols-2 gap-10'>
                <div className='col-span-1 flex gap-10 p-12 rounded-xl shadow-xl'>
