...
const OurVission = () => {
    return (
        <div className='lg:p-10 p-3 flex flex-col gap-10 md:grid grid-cols-2 mt-20'>
            ...
            <div className=' flex flex-col gap-6  col-span-1 bg-[#670000] text-white rounded-2xl p-5 md:p-10'>
            ...
            <div className=' flex flex-col gap-6  col-span-1 bg-[#060606] text-white rounded-2xl p-6 md:p-10'>
